...
const CreateAndImportCard = () => {
	return (
		<CreateAndImportDialog>
			<div className="border-fm-divider-secondary hover:bg-fm-divider-secondary/30 flex h-102 w-full max-w-77 cursor-pointer items-center justify-center border-2 border-dashed">
				<IconButton
					label="Add Story"
					variant="outlined"
