...
export default function ParametersTab() {
	...
	return (
		<div className="flex h-full overflow-hidden">
			...
			<div
				className={cn(
					'border-fm-divider-primary flex h-full flex-col border-r transition-all duration-200',
			...
			>
				...
				<div className="border-fm-divider-primary flex shrink-0 justify-end gap-2 border-t p-6">
					<Button
			...
			{/* Right: Global Chat */}
			{isGlobalChatOpen && (
				<div className="border-fm-divider-primary flex h-full w-1/3 flex-col border-l">
					<GlobalChatTab />
				</div>
			)}
		</div>
