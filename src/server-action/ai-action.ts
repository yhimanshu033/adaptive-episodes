...
export const getChatbotResponseTest = async (
	params: AIChatBotParams['aiChatbotData'] & { ep_text_json: MinifiedValue }
) => {
	return {
		action: 'dummy',
	...
	const data = (await fetchWithErrorHandling(CHATBOT_TEST, {
		api_key: process.env.NEXT_PUBLIC_LASERTOOLS_API_KEY,
		...params,
