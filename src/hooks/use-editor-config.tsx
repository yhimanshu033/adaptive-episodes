...
import useNextEpisodeContent, { getNextEpContent } from "@/hooks/query/use-next-episode-content";
import usePreviousEpisodeContent, { getPrevEpContent } from "@/hooks/query/use-prev-episode-content";
...
import { EEditorKit, EPlatform, ESidebar, RteData, ToolbarTypes, TRteContent, TRteDualViewRenderData } from "unified-editor";
...
export default function useEditorConfig() {
  ...
  const { data: contentData, isPending: isContentPending } = useEpisodeContent()
  ...
  const editorConfig = useMemo(() => {
    const data: RteData = {
      ...
      sidebarConfig: {
        ...
        enabledDefaultSidebars: [ESidebar.CHATBOT, ESidebar.COMMENTS, ESidebar.DUAL_VIEW, ESidebar.FAR, ESidebar.NOTES, ESidebar.OUTLINE],
      ...
      accessControlConfig: {
        disableEditing: !isWriter,
        enableAccessControl: !isWriter,
    ...
    return data;
  }, [onContentChange, contentData, session, isContentPending, modeToComponent, modeToTitle, modes, initialStoryData]);
